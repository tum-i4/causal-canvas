...
export class NewFormulaInput extends Component<IFormulaInputProps, IFormulaInputState> {
	...
	private uglyTimeout: null | NodeJS.Timeout = null;
	...
	private onSuggestionClicked = (selectedIdx: number) => {
		const { suggestionList, formula, cursorPos } = this.state;
		this.setState({
			...this.state,
			selectedIdx: -1,
